...
plot1 <- broom::augment(m) %>% 
  ...
  layout(yaxis = list(title = 'Prevalence of Obesity'), 
...
plot2 <- broom::augment(n) %>% 
  ...
  layout(yaxis = list(title = 'Prevalence of Diabetes'), 
         xaxis = list(title = 'Percentage of fastfood restaurants'))
...
plot3 <- broom::augment(o) %>% 
  ...
  layout(yaxis = list(title = 'Rate of stroke hospitalizations (per 100,000 adults)'), 
         xaxis = list(title = 'Percentage of fastfood restaurants'))
